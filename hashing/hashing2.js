...
function verifyBlock() {
    ...
    // Sudo language
    // For each block check whether the  Block hash from the previous block matches the prevHash from this block.
    // also check whether the outcome from blockhash(bl) is the same as the current blocks hash. 
